...
use Wayci\FrontendBundle\Form\ChangepasswordType;
use Wayci\FrontendBundle\Form\Model\Changepassword;

use Wayci\FrontendBundle\Entity\Usuario;
use Wayci\FrontendBundle\Form\UsuarioType;
    ...
    {  
        ...
        {            
            ...
            {   
                ...
                //$Distrito = $em->getRepository('BackendBundle:Distrito')->findOneBy(array('ciudad' => $entity->getCiudad()));
                //$Distrito = $em->getRepository('BackendBundle:Distrito')->findOneBy(array('id' => 1));
