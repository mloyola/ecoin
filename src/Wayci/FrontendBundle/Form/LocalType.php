...
use Wayci\FrontendBundle\Form\EventListener\AddCiudad2FieldSubscriber;
use Wayci\FrontendBundle\Form\EventListener\AddDistrito2FieldSubscriber;
...
class LocalType extends AbstractType
{
    ...
    {             
        ...
        $builder                        
            ...
            ->add( 'via', 'entity', array('class' => 'Wayci\BackendBundle\Entity\Via',
                'query_builder' => function($er) {
                return $er->createQueryBuilder('w')
                  ->orderBy('w.descripcion', 'ASC');}))
            ->add( 'interior', 'entity', array('class' => 'Wayci\BackendBundle\Entity\Interior',
                'query_builder' => function($er) {
                return $er->createQueryBuilder('w')
                  ->orderBy('w.descripcion', 'ASC');}))            
            ->add( 'horarios', 'entity', array('expanded'=>true, 'multiple'=>true,'class' => 'Wayci\FrontendBundle\Entity\Comerciohor',
            ...
            ->add( 'subcategorias', 'entity', array('expanded'=>true, 'multiple'=>true,'class' => 'Wayci\BackendBundle\Entity\Subcategoria',
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Wayci\FrontendBundle\Entity\Local'
        ));
    }
    ...
    {
        #return 'wayci_frontendbundle_local';
        return 'local';
