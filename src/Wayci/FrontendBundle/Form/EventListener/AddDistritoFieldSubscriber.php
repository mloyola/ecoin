...
namespace Wayci\FrontendBundle\Form\EventListener;
...
use Wayci\BackendBundle\Entity\Ciudad;

class AddDistritoFieldSubscriber implements EventSubscriberInterface
{
    private $factory;
