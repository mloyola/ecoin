...
use Wayci\FrontendBundle\Form\EventListener\AddCiudadFieldSubscriber;
use Wayci\FrontendBundle\Form\EventListener\AddPaisFieldSubscriber;

use Wayci\FrontendBundle\Form\EventListener\AddDistritoFieldSubscriber;
...
class UsuarioType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Wayci\FrontendBundle\Entity\Usuario'
        ));
    }
    ...
    {
        //return 'wayci_frontendbundle_usuario';
        return 'usuario';
    }
}
