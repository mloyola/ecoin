...
class Comerciohor
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Wayci\BackendBundle\Entity\Diasatencion", inversedBy="comerciohrs")
     * @ORM\JoinTable(name="comerciohors_dias")
     */
    private $dias;

    /**
    * @ORM\ManyToOne(targetEntity="Wayci\FrontendBundle\Entity\Comercio", inversedBy="comerciohrs")
    ...
    */
     ...
     * Add dias
     *
     * @param \Wayci\BackendBundle\Entity\Diasatencion $dias
     * @return Comerciohor
     */
    public function addDia(\Wayci\BackendBundle\Entity\Diasatencion $dias)
    {
        $this->dias[] = $dias;
     ...
     * @param \Wayci\BackendBundle\Entity\Diasatencion $dias
     */
    public function removeDia(\Wayci\BackendBundle\Entity\Diasatencion $dias)
    {
