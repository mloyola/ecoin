...
class Local
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Wayci\BackendBundle\Entity\Via", inversedBy="locales")
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Wayci\BackendBundle\Entity\Interior", inversedBy="locales")
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Wayci\FrontendBundle\Entity\Comercio", inversedBy="locales")
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Wayci\FrontendBundle\Entity\Comerciohor", inversedBy="horarios")
     * @ORM\JoinTable(name="locales_horarios")
     */
    private $horarios;

    /**
     * @ORM\ManyToMany(targetEntity="Wayci\FrontendBundle\Entity\Subcategoria", inversedBy="locales")
     ...
     * Set distrito
     *
     * @param \Wayci\BackendBundle\Entity\Distrito $distrito
     * @return Local
     */
    public function setDistrito(\Wayci\BackendBundle\Entity\Distrito $distrito = null)
    {
     ...
     * Get distrito
     *
     * @return \Wayci\BackendBundle\Entity\Distrito 
     */
     ...
     * Set via
     *
     * @param \Wayci\BackendBundle\Entity\Via $via
     * @return Local
     */
    public function setVia(\Wayci\BackendBundle\Entity\Via $via = null)
    {
        $this->via = $via;
     ...
     * Get via
     *
     * @return \Wayci\BackendBundle\Entity\Via 
     */
     ...
     * Set interior
     *
     * @param \Wayci\BackendBundle\Entity\Interior $interior
     * @return Local
     */
    public function setInterior(\Wayci\BackendBundle\Entity\Interior $interior = null)
    {
     ...
     * Get interior
     *
     * @return \Wayci\BackendBundle\Entity\Interior 
     */
     ...
     * Add horarios
     *
     * @param \Wayci\FrontendBundle\Entity\Comerciohor $horarios
     * @return Local
     */
    public function addHorario(\Wayci\FrontendBundle\Entity\Comerciohor $horarios)
    {
     ...
     * @param \Wayci\FrontendBundle\Entity\Comerciohor $horarios
     */
    public function removeHorario(\Wayci\FrontendBundle\Entity\Comerciohor $horarios)
    {
