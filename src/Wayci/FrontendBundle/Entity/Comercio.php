...
class Comercio implements UserInterface, \Serializable
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Wayci\BackendBundle\Entity\Categoria", inversedBy="comercios")
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Wayci\BackendBundle\Entity\Pais", inversedBy="comercios")
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Wayci\BackendBundle\Entity\Idioma", inversedBy="comercios")
    ...
    */
     ...
     * Set categoria
     *
     * @param \Wayci\BackendBundle\Entity\Categoria $categoria
     * @return Comercio
     */
    public function setCategoria(\Wayci\BackendBundle\Entity\Categoria $categoria = null)
    {
     ...
     * Get categoria
     *
     * @return \Wayci\BackendBundle\Entity\Categoria 
     */
